...
use App\Providers\TransactionCsvService;
use App\Receiver;
use App\Sender;
use App\Transaction;
...
class TransactionCreatorController extends Controller
{
    ...
    public $csvService;
    public function __construct(TransactionCsvService $csvService)
    {
    ...
    public function store(Request $request)
    {
        ...
        try {
            $this->csvService->createCsvFromTransaction($transaction->id);
        } catch (\Throwable $th) {
