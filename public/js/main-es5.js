...
var AppModule = /** @class */ (function () {
    function AppModule(injector, location, router) {
        var _this = this;
        this.injector = injector;
        this.location = location;
        this.router = router;
        var appComponentElement = Object(_angular_elements__WEBPACK_IMPORTED_MODULE_3__["createCustomElement"])(_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], { injector: injector });
        ...
        this.location.subscribe(function (data) {
            ...
            _this.router.navigateByUrl(data.url);
        });
...
var DeliveryInfoComponent = /** @class */ (function () {
    function DeliveryInfoComponent() {
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, activateRoute) {
        this.router = router;
...
var OrderFormComponent = /** @class */ (function () {
    ...
    OrderFormComponent.prototype.fillPayorInfo = function (sameAsSender) {
        for (var key in this.payorInfo.personInfoGroup.controls) {
            if (this.payorInfo.personInfoGroup.controls.hasOwnProperty(key)) {
                var payorData = this.payorInfo.personInfoGroup.controls[key];
                if (sameAsSender) {
                    var senderData = this.senderInfo.personInfoGroup.controls[key];
...
var PersonInfoComponent = /** @class */ (function () {
    function PersonInfoComponent(fb) {
        this.fb = fb;
        this.title = '';
    ...
    PersonInfoComponent.prototype.sameAsSenderChanged = function (event) {
        console.log('sameAsSenderChanged', event);
        this.sameAsSenderClicked.emit(event);
    };
    PersonInfoComponent.ctorParameters = function () { return [
...
var AvoidPasteForNonNumericDirective = /** @class */ (function () {
    function AvoidPasteForNonNumericDirective() {
    }
    AvoidPasteForNonNumericDirective.prototype.blockNonNumericPaste = function (e) {
        var val = Number(e.clipboardData.getData('Text'));
        console.log('val', val);
    ...
    return AvoidPasteForNonNumericDirective;
}());
...
var AngularMaterialModules = /** @class */ (function () {
    function AngularMaterialModules() {
    }
